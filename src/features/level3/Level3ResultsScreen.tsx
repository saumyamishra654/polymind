...
type Level3ResultsScreenProps = {
  results: Level3RoundResult[]
  onNext: () => void
}
...
export function Level3ResultsScreen({ results, onNext }: Level3ResultsScreenProps) {
  return (
    <main className="screen active">
      <div style={{ textAlign: 'center', marginTop: '3%' }}>
        <h2>Level 3 Results</h2>
        {results.map((result, index) => (
          <div key={`l3-round-${index}`}>
        ...
        <button onClick={onNext}>Go to Level 4</button>
      </div>
    </main>
  )
}
